...
"""
# Napiš software, který bude využívat prodavač v případě, že
# do obchodu přijde zákazník. Software se nejprve zeptá na kód
# součástky a poté na množství, které si zákazník chce koupit.
...
#   že poptávku lze uspokojit v plné výši, a sniž počet součástek na skladě
#   o množství požadované zákazníkem.
"""
sklad = {
  "1N4148": 250,
  "BAV21": 54,
...
kodSoucastky = str(input("Zadejte kód součástky: "))
kusy = int(input("a počet požadovaných kusů: "))

if kodSoucastky not in sklad:
    print("Součástka není skladem.")
elif kusy > sklad[kodSoucastky]:
    print(f"Máme a dodáme pouze {sklad[kodSoucastky]} ks součástky {kodSoucastky}.")
