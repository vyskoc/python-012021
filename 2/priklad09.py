...
"""
Uvažuj program, který bude pracovat s výsledky z maturitní zkoušky. Každý student může mít jeden
...
Přidej funkci ohodnot_studenta(), která bude mít jeden parametr, kterým je slovník se známkami
studenta. Funkce rozhodne, zda student prospěl, prospěl s vyznamenáním nebo neprospěl
...
"""
# jmeno = []
# for jmeno in vysledky(0):
#    jmeno.append(vysledky['Jméno'])
#    print(jmeno)
poradi = 0
sloupec = 1
suma = 0
...
for radky in vysledky:
    #print(vysledky[poradi])
    radek = (vysledky[poradi])
    for jmeno, hodnota in radek.items():
        print(hodnota)
        sloupec += 1
    poradi +=1
    sloupec += 1
